...
use_jit = False # TODO: for ONNX creation don't forget to remove
if not use_jit:
...
class FPN(ScriptModuleWrapper):
    ...
    def forward(self, convouts:List[torch.Tensor]):
        ...
        j = len(convouts)
        sizes = [(64,64),(32,32)] # TODO: Remove after creation ONNX
        for lat_layer in self.lat_layers:
            ...
            if j < len(convouts) - 1:
                ...
                x = F.interpolate(x, size=sizes[j], mode=self.interpolation_mode) # TODO: Remove after creation ONNX
