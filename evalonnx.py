...
def evalimage(net:Yolact, path:str, save_path:str=None):
    ...
    # opsetver=12
    opsetver=11
    # torch.onnx.export(net, dummy_input, "yolact-opset={0}.onnx".format(opsetver), opset_version=opsetver, verbose=True)
    # torch.onnx.export(net, dummy_input, "yolact_regnetx_1.6GF_fpn-opset{0}-final.onnx".format(opsetver), opset_version=opsetver, verbose=False)
    torch.onnx.export(net, dummy_input, "yolact_regnetx_600MF_fpn-opset{0}.onnx".format(opsetver), opset_version=opsetver, verbose=False)
    import ipdb; ipdb.set_trace()
